...
import 'package:rxdartexample/bloc/get_movies_byGenre_bloc.dart';
import 'package:rxdartexample/model/movie.dart';
import 'package:rxdartexample/model/movie_response.dart';
import 'package:rxdartexample/screens/detail_screen.dart';
                ...
                child: Column(
                  children: [
                    ...
                    Row(
                      children: [
                        Text(
                          movies[index].vote_average.toString(), style: TextStyle(
                            color: Colors.white,
                            fontSize: 10.0,
                            fontWeight: FontWeight.bold
                        ),),
